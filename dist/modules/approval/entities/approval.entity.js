...
__decorate([
    ...
    __metadata("design:type", Number)
], Approval.prototype, "batchId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => batch_entity_1.Batch, (batch) => batch.approvals, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'batch_id' }),
    __metadata("design:type", batch_entity_1.Batch)
], Approval.prototype, "batch", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'admin_id' }),
    __metadata("design:type", Number)
], Approval.prototype, "adminId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, { onDelete: 'SET NULL', nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'admin_id' }),
    __metadata("design:type", user_entity_1.User)
], Approval.prototype, "admin", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: enums_1.ApprovalDecisionStatus }),
